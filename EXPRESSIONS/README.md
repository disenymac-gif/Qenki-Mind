...
## Purpose
Expression entities live here as first-class persistent knowledge objects. Each entity is maintained in its own file, with global views used only as indexes or summaries.

## Ownership
Owned by the appropriate organ per the canonical architecture. Only that organ may write the authoritative entity file.

## Entity-First Rule
- One file per expression entity is the preferred source of truth.
